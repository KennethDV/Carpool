...
function sendemail_verify($fname, $email, $verify_token){
    ...
    <br>
    <a href= 'http://localhost:3000/xampp/htdocs/carpool/verify.php?token=$verify_token'> Click Here</a>";
...
if(mysqli_num_rows($check_email_query_run) > 0){
    ...
    $query = "INSERT INTO User (user_email, user_password, user_name, user_firstname, user_middlename, user_lastname, phone_number, user_gender, verify_token) 
    VALUES ('$email', '$pass', '$username', '$fname', '$mname', '$lname', '$phone', '$gender', '$verify_token')";
